...
private:
    ...
    Eigen::VectorXd findClosestNode(RRT *currentRRT, RRT *otherRRT);
    unsigned int countDist(std::list<Eigen::VectorXd>::iterator a,
                           std::list<Eigen::VectorXd>::iterator b);
    std::list<Eigen::VectorXd> createPath(int _robotId, 
                                          const Eigen::VectorXi &_links, 
                                          const Eigen::VectorXd &_config1, 
